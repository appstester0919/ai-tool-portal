...
(function () {
  ...
  function ToolCard({ tool, health, onAction }) {
    ...
    return React.createElement("div", {
      ...
      // Row 2: meta — equally spaced across full width with inner padding
      React.createElement("div", { className: "flex items-center justify-between gap-x-2 gap-y-0.5 text-[10px] flex-wrap min-w-0 px-1" },
        (function() {
