...
TOOLS = [
    ...
    {"id": "comfyui_3d", "name": "ComfyUI — 3D", "category": "ai_image", "icon": "Image",
     ...
     "process_patterns": ["ComfyUI_3D.*--port 8190"],
     "process_comm_filter": "python",
     "rss_warn_mb": 4000, "rss_max_mb": 8000,
     "start_cmd": f"pkill -f 'ComfyUI_3D.*--port 8190' 2>/dev/null; sleep 2; cd /mnt/d/ai/ComfyUI_3D && nohup ./venv/bin/python main.py --listen 0.0.0.0 --port 8190 > /tmp/comfyui_3d_8190.log 2>&1 &",
     "stop_cmd": "pkill -f 'ComfyUI_3D.*--port 8190'",
     "restart_cmd": "pkill -f 'ComfyUI_3D.*--port 8190'; sleep 2"},
    ...
    {"id": "comfyui_standard", "name": "ComfyUI — Standard", "category": "ai_image", "icon": "Image",
     ...
     "process_patterns": ["ComfyUI_Standard.*--port 8188"],
     "process_comm_filter": "python",
     "rss_warn_mb": 4000, "rss_max_mb": 8000,
     "start_cmd": f"pkill -f 'ComfyUI_Standard.*--port 8188' 2>/dev/null; sleep 2; cd /mnt/d/ai/ComfyUI_Standard && nohup ./venv/Scripts/python.exe main.py --listen 0.0.0.0 --port 8188 > /tmp/comfyui_standard_8188.log 2>&1 &",
     "stop_cmd": "pkill -f 'ComfyUI_Standard.*--port 8188'",
     "restart_cmd": "pkill -f 'ComfyUI_Standard.*--port 8188'; sleep 2"},
